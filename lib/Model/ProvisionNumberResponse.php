...
class ProvisionNumberResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets description
     *
     * @param string|null $description Metadata for provisioned numbers which are valid for more than 5 years
     *
     * @return $this
     */
     ...
     * Sets expiry_date
     *
     * @param float|null $expiry_date Free Trial apps will have a 30-Day Limit for their provisioned number. This is in Unix time format.
     *
     * @return $this
     */
