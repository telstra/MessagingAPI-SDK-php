...
class Message implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $message_status_url For an accepted message, ths will be the URL that can be used to check the messages status. Please refer to the Delivery Notification section.
     *
     * @return $this
     */
