...
class MessageSentResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $number_segments For SMS messages only, the value indicates the number of 160 character message segments sent.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $number_national_destinations This returns the number of domestic Australian messages sent.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $number_international_destinations This returns the number of international messages sent
     *
     * @return $this
     */
