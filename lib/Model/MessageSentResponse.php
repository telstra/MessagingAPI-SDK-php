...
class MessageSentResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $number_national_destinations This returns the number of domestic Australian messages sent.
     *
     * @return $this
     */
     ...
     *
     * @param int $number_international_destinations This returns the number of international messages sent
     *
     * @return $this
     */
