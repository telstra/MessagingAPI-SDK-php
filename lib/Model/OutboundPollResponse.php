...
class OutboundPollResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundPollResponse';
     ...
     * Sets to
     *
     * @param string|null $to The phone number (recipient) the message was sent to (in E.164 format).
     *
     * @return $this
     */
     ...
     * Sets sent_timestamp
     *
     * @param string|null $sent_timestamp The date and time when the message was sent.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $received_timestamp The date and time when the message was recieved by recipient.
     *
     * @return $this
     */
     ...
     *
     * @return \Telstra_Messaging\Model\Status|null
     */
     ...
     *
     * @param \Telstra_Messaging\Model\Status|null $delivery_status delivery_status
     *
     * @return $this
     */
