...
class ProvisionNumberRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets notify_url
     *
     * @param string $notify_url A callback URL that will be POSTed to whenever a new message arrives at this destination address. If this is not provided then you can make use the Get Replies API to poll for messages.
     *
     * @return $this
     */
