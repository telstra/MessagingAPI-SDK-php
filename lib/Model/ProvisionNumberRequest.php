...
class ProvisionNumberRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets active_days
     *
     * @param int|null $active_days The number of days before for which this number is provisioned. Usually this will be same as the plan you buy.
     *
     * @return $this
     */
     ...
     * Sets callback_data
     *
     * @param string|null $callback_data A JSON that will be sent as the body in the POST to the notifyURL. This can be any meaningful data relevant to your application.
     *
     * @return $this
     */
