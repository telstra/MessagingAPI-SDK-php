...
class ProvisionNumberRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['callback_data'] = isset($data['callback_data']) ? $data['callback_data'] : null;
    }
     ...
     * Sets active_days
     *
     * @param int $active_days The number of days before for which this number is provisioned. Usually this will be same as the plan you buy.
     *
     * @return $this
     */
     ...
     * Sets notify_url
     *
     * @param string $notify_url A notification URL that will be POSTed to whenever a new message (e.g. a reply to a message sent) arrives at this destination address.  If this is not provided then you can use the Get /sms or /mms API to poll for reply messages. *Please note that the notification URLs and the Get /sms or /mms call are exclusive. If a notification URL has been set then the GET call will not provide any useful information.*
     *
     * @return $this
     */
     ...
     * Sets callback_data
     *
     * @param string $callback_data A JSON that will be sent as the body in the POST to the notifyURL. This can be any meaningful data relevant to your application.
     *
     * @return $this
     */
